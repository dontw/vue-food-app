  ...
  <div class="header">
      ...
      <div class="top-wrapper">
          ...
          <form class="search-wrapper">
              ...
              <input type="text" placeholder="搜索店內商品" class="search-bar">
          </form>
          <div class="more-wrapper">
            <a class="spelling-bt" href="#">併單</a>
            <div class="more-bt">
                <i class="s-radius"></i>
                <i class="s-radius"></i>
                <i class="s-radius"></i>
        ...
        <div class="bulletin-detail" v-show="bulletinDetailIsShow">
            <div class="detail-wrapper">
                <div class="main-wrapper" :style="detail_bg">
                    ...
                    <div class="score">
                        <my-star :score="poiInfo.wm_poi_score"></my-star>
...
export default {
    ...
    methods: {
        showBulletin() {
            this.bulletinDetailIsShow = true;
        },
        closeBulletin() {
            this.bulletinDetailIsShow = false;
        }
    }
};
</script>
